...
interface ChartsMap { [key: string]: any; }
interface Stats { temperature?: number; humidity?: number; pressure?: number; }
interface Measurement { time: string; temperature: number; humidity: number; pressure: number; }
